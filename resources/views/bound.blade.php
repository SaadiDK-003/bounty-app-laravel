                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form method="post" action="{{ route('add-bound') }}"
                        ...
                        <div class="col-span-2">
                            ...
                            <x-text-input id="price" name="price" type="number" class="mt-1 block w-full [appearance:textfield]"
                        ...
                        <div class="col-span-2">
                            ...
                            <x-text-input id="slots" name="slots" type="number" class="mt-1 block w-full [appearance:textfield]"
