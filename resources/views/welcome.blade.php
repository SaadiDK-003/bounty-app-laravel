            ...
            <div class="col p-5 row-span-4">
                <div class="content-wrapper border-[3px] border-slate-700 dark:border-white rounded-md h-full bg-white dark:bg-slate-800">
                    ...
                    <div class="grid grid-cols-5 gap-3 p-3 px-6 justify-items-center relative">
                        ...
                        <a href="#!" class="flex items-center justify-center rounded-full text-white dark:text-black text-2xl bg-slate-400 dark:bg-white w-14 h-14 hover:bg-slate-700 dark:hover:bg-slate-400 active:bg-red-700 dark:active:text-white active:pointer-events-none">10</a>
                        <!-- row 3 -->
                        <a href="#!" class="flex items-center justify-center rounded-full text-white dark:text-black text-2xl bg-slate-400 dark:bg-white w-14 h-14 hover:bg-slate-700 dark:hover:bg-slate-400 active:bg-red-700 dark:active:text-white active:pointer-events-none">11</a>
                        <a href="#!" class="flex items-center justify-center rounded-full text-white dark:text-black text-2xl bg-slate-400 dark:bg-white w-14 h-14 hover:bg-slate-700 dark:hover:bg-slate-400 active:bg-red-700 dark:active:text-white active:pointer-events-none">12</a>
                        <a href="#!" class="flex items-center justify-center rounded-full text-white dark:text-black text-2xl bg-slate-400 dark:bg-white w-14 h-14 hover:bg-slate-700 dark:hover:bg-slate-400 active:bg-red-700 dark:active:text-white active:pointer-events-none">13</a>
                        <a href="#!" class="flex items-center justify-center rounded-full text-white dark:text-black text-2xl bg-slate-400 dark:bg-white w-14 h-14 hover:bg-slate-700 dark:hover:bg-slate-400 active:bg-red-700 dark:active:text-white active:pointer-events-none">14</a>
                        <a href="#!" class="flex items-center justify-center rounded-full text-white dark:text-black text-2xl bg-slate-400 dark:bg-white w-14 h-14 hover:bg-slate-700 dark:hover:bg-slate-400 active:bg-red-700 dark:active:text-white active:pointer-events-none">15</a>
                    </div>
                    <div class="info w-full flex items-center justify-between py-3 px-4 -bottom-14">
                        <span class="bg-red-600 text-white px-2 rounded-sm">RED TAKEN</span>
                        <span class="bg-slate-500 dark:bg-slate-600 text-white px-2 rounded-sm"><span class="dark:hidden">GRAY</span><span class="hidden dark:inline">WHITE</span> AVAILABLE</span>
